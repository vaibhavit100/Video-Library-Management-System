...
<%
String str = null;
str=session.getAttribute("delmovmsg").toString();

if (str.equals("msg")){}
else{
%>
<script type="text/javascript">
alert("<%=session.getAttribute("delmovmsg")%>");
</script>
<%	
}
%>
<br>
<b>Search for Movie to be deleted !!!</b> 
<br>
<br>
<form id="searchMovies" onsubmit="return validateInput()" method="post" action="searchMovie">
