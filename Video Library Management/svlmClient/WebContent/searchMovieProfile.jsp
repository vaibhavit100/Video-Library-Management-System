...
<b>Select the movies to view Profile !!!</b>
<br>
<form name="delMovies" id="delMovies" onsubmit="" method="post" action="custDetails">
...
<tr>
<td>
<input TYPE="radio" name=movid VALUE=<%=a[i].getmovid()%>>
<%=a[i].getmovid()%>
</td>
<td>
<%=a[i].getmovname()%>
...
<%}}else{%>
<jsp:forward page="noResult3.jsp" /> 
<%}%>

</table>
<br>
<input class="submit" type="submit" value="Show Customer Details" >
</form>
