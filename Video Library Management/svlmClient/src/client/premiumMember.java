...
import bean.pMemberbean;


/**
 * Servlet implementation class premiumMember
 */
@WebServlet("/premiumMember")
public class premiumMember extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			pMemberbean a[]=new pMemberbean[input.length];
			...
			response.sendRedirect("premiummembers.jsp");
