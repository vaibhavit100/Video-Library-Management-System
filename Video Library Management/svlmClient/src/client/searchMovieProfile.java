...
/**
 * Servlet implementation class searchMovieProfile
 */
@WebServlet("/searchMovieProfile")
public class searchMovieProfile extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			response.sendRedirect("searchMovieProfile.jsp");
