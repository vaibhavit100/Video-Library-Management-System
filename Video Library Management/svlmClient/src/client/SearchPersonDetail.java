 ...
 */
@WebServlet("/SearchPersonDetail")
public class SearchPersonDetail extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//	{
			...
			response.sendRedirect("showsearchpersondetail.jsp");
			//}
